 ...
 *
 */
public class InvalidOpenCreateAdminAction extends Action
{
	private List<String> reasonList;
	
	public InvalidOpenCreateAdminAction()
	{
		reasonList = new ArrayList<>();
	}
	
	public InvalidOpenCreateAdminAction(List<String> reasonList)
	{
		this.reasonList = reasonList;
	}
	
	public InvalidOpenCreateAdminAction(String reason)
	{
		reasonList = new ArrayList<>();
