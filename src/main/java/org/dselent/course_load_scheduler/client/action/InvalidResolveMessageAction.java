 ...
 *
 */
public class InvalidResolveMessageAction extends Action
{
	private List<String> reasonList;
	
	public InvalidResolveMessageAction()
	{
		reasonList = new ArrayList<>();
	}
	
	public InvalidResolveMessageAction(List<String> reasonList)
	{
		this.reasonList = reasonList;
	}
	
	public InvalidResolveMessageAction(String reason)
	{
		reasonList = new ArrayList<>();
